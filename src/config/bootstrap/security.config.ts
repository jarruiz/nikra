...
export function setupSecurity(app: INestApplication): void {
  ...
  app.enableCors({
    // TEMPORAL: Permitir todos los orígenes
    // TODO: Descomentar la configuración anterior y comentar 'origin: true' cuando sea necesario
    origin: true, // TEMPORAL: Permitir todos los orígenes
    
    // CONFIGURACIÓN ANTERIOR (comentada para facilitar reverso):
  ...
  // Log de advertencia
  console.warn('⚠️  CORS: Configurado para permitir TODOS los orígenes (TEMPORAL)');
